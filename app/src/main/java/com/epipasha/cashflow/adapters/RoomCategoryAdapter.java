...
public class RoomCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RoomCategoryAdapter(HeaderClickListener headerClickListener, ItemClickListener itemClickListener) {
    ...
    private CategoryHolder onCreateItemViewHolder(ViewGroup parent) {
        ...
        return new RoomCategoryAdapter.CategoryHolder(view);
    }
    ...
    private HeaderHolder onCreateHeaderViewHolder(ViewGroup parent) {
        ...
        return new RoomCategoryAdapter.HeaderHolder(view);
    }
