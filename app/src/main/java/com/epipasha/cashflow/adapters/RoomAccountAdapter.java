...
public class RoomAccountAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RoomAccountAdapter(ItemClickListener itemClickListener) {
    ...
    private RecyclerView.ViewHolder onCreateHeaderViewHolder(@NonNull ViewGroup parent, int viewType){
        ...
        return new RoomAccountAdapter.HeaderHolder(view);
    }
    ...
    private RecyclerView.ViewHolder onCreateItemViewHolder(@NonNull ViewGroup parent, int viewType){
        ...
        return new RoomAccountAdapter.AccountHolder(view);
    }
