...
public class RoomOperationAdapter extends RecyclerView.Adapter<RoomOperationAdapter.OperationHolder> {
    ...
    public RoomOperationAdapter(Context context, ItemClickListener itemClickListener, ItemLongClickListener itemLongClickListener) {
    ...
    @NonNull
    @Override
    public RoomOperationAdapter.OperationHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_operation, parent, false);

        return new RoomOperationAdapter.OperationHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(RoomOperationAdapter.OperationHolder holder, int position) {
