...
import com.epipasha.cashflow.activities.RoomDetailOperationActivity;
import com.epipasha.cashflow.adapters.RoomOperationAdapter;
...
public class RoomOperationListFragment extends Fragment implements RoomOperationAdapter.ItemClickListener, RoomOperationAdapter.ItemLongClickListener{

    private RecyclerView rvList;
    private RoomOperationAdapter mAdapter;
    ...
    private void initRecycledView(){
        ...
        mAdapter = new RoomOperationAdapter(getContext(), this, this);
    ...
    public void onItemClickListener(int itemId) {
        ...
        Intent intent = new Intent(getActivity(), RoomDetailOperationActivity.class);
        intent.putExtra(RoomDetailOperationActivity.EXTRA_OPERATION_ID, itemId);
