...
public class RoomAnalyticActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppExecutors.getInstance().discIO().execute(new Runnable() {
            ...
            public void run() {
                ...
                list.observe(RoomAnalyticActivity.this, new Observer<List<MonthCashflow>>() {
                    @Override
                ...
                builder.setTitle("Choose grafics")
                        ...
                        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                Prefs.AnalyticChartPrefs.saveShowInGrafic(RoomAnalyticActivity.this, values[0]);
                                Prefs.AnalyticChartPrefs.saveShowOutGrafic(RoomAnalyticActivity.this, values[1]);
                                Prefs.AnalyticChartPrefs.saveShowInBudgetGrafic(RoomAnalyticActivity.this, values[2]);
                                Prefs.AnalyticChartPrefs.saveShowOutBudgetGrafic(RoomAnalyticActivity.this, values[3]);
                                Prefs.AnalyticChartPrefs.saveShowDeltaGrafic(RoomAnalyticActivity.this, values[4]);
                                Prefs.AnalyticChartPrefs.saveShowCashflowGrafic(RoomAnalyticActivity.this, values[5]);
